...
actual class PhotoPicker {
    ...
    // Delegate class implementing necessary protocols
    private class PickerDelegate(private val callback: (File?) -> Unit) : NSObject(),
        ...
        // Override method to handle a media picked be user
        override fun imagePickerController(
            picker: UIImagePickerController,
            didFinishPickingMediaWithInfo: Map<Any?, *>
        ) {
            // Extract URL of the picked media
        ...
        // Override method to handle the cancellation of the picker
